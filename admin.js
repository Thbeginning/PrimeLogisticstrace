...
const TRANSPORT_HUBS = {
  plane: [
    ...
    { name: 'Cape Town International Airport', lat: -33.9715, lng: 18.6021, type: 'International Airport' },
  ...
  ship: [
    ...
    { name: 'Port of Cape Town, South Africa', lat: -33.9036, lng: 18.4320, type: 'Major Seaport' },
  ...
  bus: [
    ...
    { name: 'Cape Town, South Africa', lat: -33.9249, lng: 18.4241, type: 'Major City' },
  ...
  train: [
    ...
    { name: 'Cape Town Railway Station', lat: -33.9214, lng: 18.4231, type: 'Rail Hub' },
...
document.getElementById('create-shipment-form')?.addEventListener('submit', async e => {
  ...
  const payload = {
    ...
    distance_km:      document.getElementById('cs-distance')?.value.trim() || null,
